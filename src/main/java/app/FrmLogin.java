...
public class FrmLogin extends JFrame {
	...
	private String leerUsuario() {
		if (!txtUsuario.getText().matches("^[A-Za-z0-9+_.-]+@(.+)$")) {
	...
	void registrar() {
		 String usuario = leerUsuario(); // Obtener el usuario del campo de texto
         String clave = txtClave.getText(); // Obtener la clave del campo de texto
